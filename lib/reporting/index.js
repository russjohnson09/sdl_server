...
`;
    ...
    update: function(table,data,now)
    {
        now = now || new Date();
        data.updated_ts = data.updated_ts || now;
    ...
    updateUsageAndErrorCounts: function(usage_and_error_counts,now,full_app_id_supported)
    {
    ...
    appUsageInsert: function(app_id,obj,now)
    {
        let {
    ...
    updateAppLevelUsageAndErrorCounts: function(app_level,now,full_app_id_supported)
    {
    ...
    updatePolicyTableUpdateRequests: function(policyTableObject,now)
    {
        let trigger_event;
        try {
    ...
    getTotalDeviceModels: function(expireDate)
    {
    ...
    getTotalDeviceCarrier: function(expireDate)
    {
        expireDate = expireDate || this.getExpireDate();
        let {rows} = await this.doQuery(
          {
    ...
    getTotalDeviceOs: function(expireDate)
    {
        expireDate = expireDate || this.getExpireDate();
        let {rows} = await this.doQuery(
          {
    ...
    getPolicyTableUpdatesByTrigger: function(expireDate)
    {
        expireDate = expireDate || this.getExpireDate();
        let {rows} = await this.doQuery(
          {
...
;`,
    ...
    getPolicyTableUpdatesByTriggerTotal function(expireDate)
    {
        expireDate = expireDate || this.getExpireDate();
        let {rows} = await this.doQuery(
          {
...
;`,
    ...
    getAppUsageTimeHistory: function(id)
    {
...
;`,
    ...
    getAppUsageReport: function(appId)
    {
    ...
    getPolicyTableUpdatesReport: function()
    {
...
module.exports = function(config)
{
    ...
    reportingService.db = this.config.db;
    if (!config || !config.db)
    {
