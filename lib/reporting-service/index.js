...
let reportingService = {
    ...
    //    //TODO use callback instead
    removeOldDeviceData: async function(cb)
    {
        cb = cb || function(){};
        let expiration = moment().subtract(reportingService.expirationDays,'days').toDate();
    ...
    getTotalDeviceModels: function(expireDate,cb)
    {
        ...
        reportingService.sqlCommand(query,function(err,rows) {
    ...
    getPolicyTableUpdatesByTrigger: function(expireDate,cb)
    {
        ...
        console.log(`getPolicyTableUpdatesByTrigger request`)
...
//           });
        ...
        reportingService.sqlCommand(query,function(error,rows) {
            ...
            // cbCount++;
            // console.log(`getPolicyTableUpdatesByTrigger cb`,cbCount);
            cb(result);
        })
    },
...
//           });
    ...
    getDeviceReport: async function(cb)
    {
        let expireDate = reportingService.getExpireDate();
