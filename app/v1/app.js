...
${JSON.stringify(req.body,null,4)}
  ++++++++=REQUEST END
		...
		//2019-07-12 10:19:32.925 28195-28382/io.livio.sdltestsuite.app1 E/SdlProxy: 4.8.1: sendSystemRequestToUrl: Data in JSON Object neither an array nor a string.
		//javasuite does do some validation to make sure the policy_table is in the data of the json response.
		if (false)
		{
			let policy_table =
				{
						...
						"policy_table": {
							...
							"app_policies": {
								...
								"584421907": {
									...
									"priority": "NONE",
									"default_hmi": "NONE",
									"groups": ["Base-4", "RemoteControl", "Location-1", "VehicleInfo-3"],
									"RequestType": [],
									"RequestSubType": [],
